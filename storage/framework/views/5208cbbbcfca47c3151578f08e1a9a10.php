...
<?php $__env->startSection('title', 'Hasil Test Kualitas Tidur'); ?>
                ...
                <div class="stats-card stats-card-primary">
                    <div class="stats-card-body">
                        ...
                        <div class="stats-content">
                            ...
                            <h2 class="stats-value"><?php echo e($penggunas->count()); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card stats-card-info">
                    <div class="stats-card-body">
                        ...
                        <div class="stats-content">
                            ...
                            <h2 class="stats-value"><?php echo e($penggunas->sum('total_tests')); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card stats-card-success">
                    <div class="stats-card-body">
                        ...
                        <div class="stats-content">
                            ...
                            <h2 class="stats-value"><?php echo e($penggunas->sum('completed_tests')); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="stats-card stats-card-warning">
                    <div class="stats-card-body">
                        ...
                        <div class="stats-content">
                            ...
                            <h2 class="stats-value"><?php echo e($penggunas->sum('ongoing_tests')); ?></h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="data-table-body">
                <div class="table-container">
                    <table class="modern-table" id="penggunaTable">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $penggunas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pengguna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="table-row" data-id="<?php echo e($pengguna->id); ?>">
                                    <td class="td-number">
                                    ...
                                    <td class="td-name">
                                        <div class="user-info">
                                            ...
                                            <span class="user-name text-capitalize"><?php echo e($pengguna['nama_lengkap']); ?></span>
                                        </div>
                                    </td>
                                    <td class="td-total">
                                        <div class="test-progress">
                                            <span class="test-count"><?php echo e($pengguna->total_tests); ?></span>
                                            <div class="progress-bar-wrapper">
                                                ...
                                                <div class="progress-bar-container">
                                                    <div class="progress-bar-fill" style="width: <?php echo e($completion); ?>%">
                                                    </div>
                                                </div>
                                                <span class="progress-text"><?php echo e(number_format($completion, 0)); ?>%</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="td-status">
                                        ...
                                        ?>
                                        <?php if($latestTest): ?>
                                            <?php if($latestTest->status == 'completed'): ?>
                                                <span class="status-badge status-completed">
                                                    <i class="fas fa-check-circle me-1"></i>Selesai
                                                </span>
                                            <?php elseif($latestTest->status == 'ongoing'): ?>
                                    ...
                                    <td class="td-date">
                                        <?php if($latestTest): ?>
                                            <span
                                                class="date-text"><?php echo e(\Carbon\Carbon::parse($latestTest->created_at)->format('d M Y')); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td class="td-score">
                                        ...
                                        <?php if($avgScore): ?>
                                            <div class="score-wrapper">
                                                <span class="score-value"><?php echo e(number_format($avgScore, 1)); ?></span>
                                                <?php if($avgScore <= 5): ?>
                                    ...
                                    <td class="td-action">
                                        <div class="action-buttons">
                                            <a href="<?php echo e(route('admin.test-quality.detail', $pengguna->id)); ?>"
                                                class="action-btn action-btn-view" title="Lihat Detail">
                                                <i class="fas fa-eye"></i>
                                                <span class="action-text">Detail</span>
                                            </a>
                                            <?php if($latestTest): ?>
                                                <a href="<?php echo e(route('admin.test-quality.create', ['test' => $latestTest->id])); ?>"
                        ...
                        <div class="col-12 col-md-6">
                            <div class="footer-info">
                                <span class="text-muted">
                                    Menampilkan <strong class="text-dark"><?php echo e($penggunas->count()); ?></strong> pengguna test
                                </span>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\si-besti\resources\views/admins/hasil-test/index.blade.php ENDPATH**/ ?>