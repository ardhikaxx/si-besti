        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title"><i class="fas fa-image me-2"></i>Bukti Kegiatan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center p-4" style="background: #f8f9fa;">
                    <img id="modalImage" src="" alt="Bukti Kegiatan" 
        ...
        function populateSleepTable(sleepData) {
            ...
            sleepData.forEach((item, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="text-center">
                        ${item.bukti_gambar ?
                            `<button type="button" class="btn btn-sm btn-outline-primary" onclick="showImageModal('/storage-file/${item.bukti_gambar}')" title="Lihat Bukti">
                                <i class="fas fa-image"></i>
                            </button>` :
                            `<span class="text-muted"><i class="fas fa-times"></i></span>`}
                    </td>
