...
<?php $__env->startSection('title', 'Login Admin - SI Besti'); ?>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-card-body">
                ...
                <!-- Form Login -->
                <form id="adminLoginForm" method="POST" action="<?php echo e(route('admin.login.post')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="auth-form-group">
                        ...
                        <div class="auth-input-group">
                            <input type="email" class="auth-input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="auth-form-group">
                        ...
                        <div class="auth-input-group">
                            <input type="password" class="auth-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="auth-footer">
                    <p>&copy; <?php echo e(date('Y')); ?> SI Besti - Sistem Administrator</p>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (submitForgotBtn) {
                submitForgotBtn.addEventListener('click', async function() {
                    ...
                    try {
                        console.log('Sending request to:', '<?php echo e(route('admin.forgot.password')); ?>');
                        ...
                        // Send AJAX request
                        const response = await fetch('<?php echo e(route('admin.forgot.password')); ?>', {
                            method: 'POST',
                            headers: {
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\si-besti\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>