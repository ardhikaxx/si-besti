                ...
                <div class="dropdown">
                    <button class="btn d-flex align-items-center p-0 border-0" type="button" id="userDropdown"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            ?>
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($namaAdmin)); ?>&background=0856C8&color=fff&size=128"
                                alt="Admin Avatar" class="avatar me-2">
                            <div class="d-none d-md-block text-start">
                                <div class="fw-bold small"><?php echo e($namaAdmin); ?></div>
                            </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0" aria-labelledby="userDropdown">
                        <li>
                            <a class="dropdown-item d-flex align-items-center mt-2" href="<?php echo e(route('admin.profile')); ?>">
...
</header><?php /**PATH C:\xampp\htdocs\si-besti\resources\views/partials/header.blade.php ENDPATH**/ ?>