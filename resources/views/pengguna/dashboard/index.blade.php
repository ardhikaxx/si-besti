                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        @else
                                            <div class="text-center py-5 empty-state">
                                                ...
                                                <a href="{{ route('pengguna.sleep-tracking.index') }}" class="btn btn-custom btn-sm">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        @else
                                            <div class="text-center py-5 empty-state">
                                                ...
                                                <a href="{{ route('pengguna.quality-test.index') }}" class="btn btn-custom btn-sm">
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card border-0 shadow-lg feature-card h-100">
                            <div class="card-body text-center d-flex flex-column p-4">
                                ...
                                <p class="card-text text-muted grow mb-4">Input dan tracking jam tidur sampai jam bangun Anda.</p>
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card border-0 shadow-lg feature-card h-100">
                            <div class="card-body text-center d-flex flex-column p-4">
                                ...
                                <p class="card-text text-muted grow mb-4">Segera test kualitas tidur untuk mengetahui kualitas tidur Anda.</p>
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card border-0 shadow-lg feature-card h-100">
                            <div class="card-body text-center d-flex flex-column p-4">
                                ...
                                <p class="card-text text-muted grow mb-4">Putar Murottal Al-Qur'an untuk menemani waktu tidur Anda.</p>
